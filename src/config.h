...
// - Line Sensor A (front)
const int LINE_SENSOR_PIN_A1 = A2, LINE_SENSOR_PIN_A2 = A1,
                    LINE_SENSOR_PIN_A3 = A0;
const int LINE_SENSOR_A_THRESHOLD = 150;
// - Line Sensor B (side)
const int LINE_SENSOR_PIN_B1 = A3, LINE_SENSOR_PIN_B2 = A4,
                    LINE_SENSOR_PIN_B3 = A5;
const int LINE_SENSOR_B_THRESHOLD = 500;
// - Ultrasonic Sensor
const int ULTRASONIC_TRIG_PIN = 5, ULTRASONIC_ECHO_PIN = 46; // TODO: Define pins
// ===== OUTPUTS =====
// - LED
...
// - Servo Motor B (left)
const int SERVO_PIN_B1 = 10, SERVO_PIN_B2 = 9; // TODO: Define pins
...
const float LINE_FOLLOW_REGULAR_KP = 40.0;
const float LINE_FOLLOW_REGULAR_KD = 10.0;
// All IO list:
// INP button [1 pin]
